...
Begin VB.Form TJurnal2 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Transaksi Pengeluaran Kas/Bank"
   ClientHeight    =   7590
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14355
   ...
   Begin VB.ComboBox Combo2 
      Height          =   315
      ItemData        =   "TJurnal2.frx":0000
      Left            =   9600
      List            =   "TJurnal2.frx":000A
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      ItemData        =   "TJurnal2.frx":0019
      Left            =   9600
      List            =   "TJurnal2.frx":0023
      Style           =   2  'Dropdown List
      TabIndex        =   15
      Top             =   1440
      Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "TJurnal2.frx":0032
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "TJurnal2.frx":0A44
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "TJurnal2.frx":1456
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "TJurnal2.frx":1E68
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "TJurnal2.frx":287A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "TJurnal2.frx":328C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "TJurnal2.frx":3C9E
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Set mypostdata = New TPostingKeu
    ...
    If myTrxKasBank.RecordCount > 0 Then
        mypostdata.JENIS_TRX = "PENGELUARAN"
...
Private Sub Command2_Click()
    ...
    mydisp1.MyData "select NO_JURNAL,TGL_JURNAL,KETERANGAN,KD_CAB,KODE,NAMA,KODE_ADM,NAMA_ADM from v_ajukasbank_hd3 WHERE kd_cab in(select kd_cab from v_list_user_cab where userid='" & idxuser & "')" & " AND JENIS LIKE '%PENGELUARAN%'"
    mydisp1.Show 1
...
Select Case Button.Index
 ...
 Case Is = 4
    ...
    SETOBJMENU False
    NumEdit = True
    GetNama "SELECT NO_JURNAL,TGL_JURNAL,NO_AJU,KODE,NAMA,KODE_ADM,NAMA_ADM,KETERANGAN,CATATAN,KD_CAB,NAMA_CAB,POST FROM V_KASBANK_HD WHERE (JENIS='PENGELUARAN KAS' OR JENIS='PENGELUARAN BANK') AND kd_cab in(select kd_cab from v_list_user_cab where userid='" & idxuser & "')" & " ORDER BY NO_JURNAL,TGL_JURNAL ASC", 123
Case Is = 5
...
'***********************************************
    ...
    rsCetakBukti.Open LCase("SELECT * FROM V_KASBANK WHERE JENIS='PENGELUARAN " & UCase(clsakun_ap.Kode_rek) & "' AND NO_JURNAL='" & Notrans.Text & "' AND TGL_JURNAL='" & Format(Tgl.Value, "YYYY-MM-dd") & "'"), con, adOpenDynamic, adLockOptimistic, adCmdText


'    Set rsProfiles = Nothing
'    Set rsProfiles = New ADODB.Recordset
'    rsProfiles.Open LCase("SELECT * FROM IDENTITAS"), con, adOpenDynamic, adLockOptimistic, adCmdText
...
'        .Formulas(2) = "profile_pt='" & rsProfiles.Fields("nama_usaha").Value & "'"
...
'***********************************************
    ...
    RsData1.Open LCase("SELECT * FROM KASBANK_HD WHERE JENIS='PENGELUARAN " & UCase(clsakun_ap.Kode_rek) & "' AND NO_JURNAL='" & Notrans.Text & "'"), con, adOpenDynamic, adLockOptimistic, adCmdText
    ...
    con.BeginTrans
        ...
        RsData1.Fields("JENIS").Value = "PENGELUARAN " & UCase(clsakun_ap.Kode_rek)
    ...
    Do Until SetTmpData.EOF
       RsData2.AddNew
        ...
        RsData2.Fields("JENIS").Value = "PENGELUARAN " & UCase(clsakun_ap.Kode_rek)
...
'***********************************************
    ...
    Set RsData1 = Nothing
    Set RsData1 = New ADODB.Recordset
    RsData1.Open LCase("DELETE FROM KASBANK_DT WHERE JENIS='PENGELUARAN " & UCase(clsakun_ap.Kode_rek) & "' AND NO_JURNAL='" & Notrans.Text & "'"), con, adOpenDynamic, adLockOptimistic, adCmdText
    Set RsData2 = Nothing
    Set RsData2 = New ADODB.Recordset
    RsData2.Open LCase("DELETE FROM KASBANK_HD WHERE JENIS='PENGELUARAN " & UCase(clsakun_ap.Kode_rek) & "' AND NO_JURNAL='" & Notrans.Text & "'"), con, adOpenDynamic, adLockOptimistic, adCmdText
   Dim myTRX As ClsUserAkses
   Set myTRX = New ClsUserAkses
